...
# Version 1.3, Modified vison encoder to use ResNet50 and BERT as the text encoder.
...
class ITM_Classifier(ITM_DataLoader):
    ...
    # Create vision encoder to extract features from images using ResNet50 as the backbone.
